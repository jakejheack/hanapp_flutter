...
class _ChatScreenState extends State<ChatScreen> {
  ...
  bool _isLister = true; // NEW: To show/hide Reject/Start buttons
  ...
  void didChangeDependencies() {
    ...
    if (_currentUser != null && _recipientId == null) { // Ensure current user is loaded and arguments not yet processed
  ...
  Future<void> _fetchMessages() async {
    if (_currentUser == null || _recipientId == null) return;
  ...
  Future<void> _sendMessage() async {
    if (_messageController.text.trim().isEmpty || _currentUser == null || _recipientId == null) {
      return;
    }
  ...
  Widget build(BuildContext context) {
    if (_currentUser == null || _recipientId == null || _isLoadingMessages) {
      return Scaffold(
